...
import com.webtree.baumgartner.storyapp.R;
...
public class Story {
    ...
    public Story() {
        ...
        mPages[5] = new Page(
                R.mipmap.page5,
                "After a long walk slightly uphill, you end up at the top of a small crater." +
                        " You look around, and are overjoyed to see your favorite android, %1$s-S1124. " +
                        "It had been lost on a previous mission to Mars! You take it back to your ship and fly back to Earth.");
